...
class NeighborhoodsController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('index','admin','delete','reverse'),
				'users'=>array('admin'),
			),
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Neighborhoods'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->OGR_FID));
		}
	 ...
	 */
 	...
 	{
 	  // reverses the Zillow neighborhood data lat long for google maps
 	  echo '<p>Reversing neighborhood data...this may take a while...</p>';
 	  Neighborhoods::model()->reverseNeighborhoodData();
 	  echo 'Completed';
  }
